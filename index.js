...
const token = '7002100461:AAHgPU1wwE9eiM1P-12sEVbqCioL54scgJ8'
...
function logActivity(msg) {
  ...
  console.log(`7002100461:AAHgPU1wwE9eiM1P-12sEVbqCioL54scgJ8
  console.log(`• User ID: ${6161481092}`);
  console.log(`• Username: ${user.username || '@Hunterxup12'}`);
  console.log(`• Chat ID: ${6161481092}`);
